...
INSERT INTO SYS_PRINS (SYS_PRIN, CLIENT, CUST_TYPE, START_DATE, UNDELIVERABLE, STAT_A, STAT_B, STAT_C, STAT_D, STAT_E, STAT_F, STAT_G, STAT_H, STAT_I, STAT_J, STAT_K, STAT_L, STAT_M, STAT_N, STAT_O, STAT_P, STAT_Q, STAT_R, STAT_S, STAT_T, STAT_U, STAT_V, STAT_W, STAT_X, STAT_Y, STAT_Z, PO_BOX, NO_RENEWAL, BLOCK_CARD, ADDR_FLAG, TEMP_AWAY, RSPS, SESSION, BAD_STATE, N_BAD_STATE, N_A_STAT_RCK, NM_13, TEMP_AWAY_ATTS, REPORT_METHOD, CONTACT, PHONE, ACTIVE, NOTES, RET_STAT, DES_STAT) VALUES
 ('SYS001', 'CLIENT1', 'TypeA', '2024-01-01', 'N', 'stat_a 1', 'stat_b 1', 'stat_c 1', 'stat_d 1', 'stat_e 1', 'stat_f 1', 'stat_g 1', 'stat_h 1', 'stat_i 1', 'stat_j 1', 'stat_k 1', 'stat_l 1', 'stat_m 1', 'stat_n 1', 'stat_o 1', 'stat_p 1', 'stat_q 1', 'stat_r 1', 'stat_s 1', 'stat_t 1', 'stat_u 1', 'stat_v 1', 'stat_w 1', 'stat_x 1', 'stat_y 1', 'stat_z 1', 'Y', 'N', 'N', 'Flag1', 'Away1', 'RSPS1', 'Session1', 'Bad1', 'NB1', 'NR1', 'NM31', 'TempAtts1', 'Method1', 'John Doe', '123-456-7890', 'Y', 'Note1', 'Return Status 1', 'Destroy Status 1'),
 ('SYS002', 'CLIENT2', 'TypeB', '2024-02-01', 'Y', 'stat_a 2', 'stat_b 2', 'stat_c 2', 'stat_d 2', 'stat_e 2', 'stat_f 2', 'stat_g 2', 'stat_h 2', 'stat_i 2', 'stat_j 2', 'stat_k 2', 'stat_l 2', 'stat_m 2', 'stat_n 2', 'stat_o 2', 'stat_p 2', 'stat_q 2', 'stat_r 2', 'stat_s 2', 'stat_t 2', 'stat_u 2', 'stat_v 2', 'stat_w 2', 'stat_x 2', 'stat_y 2', 'stat_z 2', 'N', 'Y', 'Y', 'Flag2', 'Away2', 'RSPS2', 'Session2', 'Bad2', 'NB2', 'NR2', 'NM32', 'TempAtts2', 'Method2', 'Jane Smith', '987-654-3210', 'N', 'Note2', 'Return Status 2', 'Destroy Status 2'),
 ('SYS003', 'CLIENT3', 'TypeC', '2024-03-01', 'N', 'stat_a 3', 'stat_b 3', 'stat_c 3', 'stat_d 3', 'stat_e 3', 'stat_f 3', 'stat_g 3', 'stat_h 3', 'stat_i 3', 'stat_j 3', 'stat_k 3', 'stat_l 3', 'stat_m 3', 'stat_n 3', 'stat_o 3', 'stat_p 3', 'stat_q 3', 'stat_r 3', 'stat_s 3', 'stat_t 3', 'stat_u 3', 'stat_v 3', 'stat_w 3', 'stat_x 3', 'stat_y 3', 'stat_z 3', 'Y', 'N', 'N', 'Flag3', 'Away3', 'RSPS3', 'Session3', 'Bad3', 'NB3', 'NR3', 'NM33', 'TempAtts3', 'Method3', 'Alice Brown', '555-123-6789', 'Y', 'Note3', 'Return Status 3', 'Destroy Status 3');
